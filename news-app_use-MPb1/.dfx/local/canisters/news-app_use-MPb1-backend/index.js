...
import { idlFactory } from './news-app_use-MPb1-backend.did.js';
export { idlFactory } from './news-app_use-MPb1-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_NEWS_APP_USE_MPB1_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./news-app_use-MPb1-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the news-app_use-MPb1-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./news-app_use-MPb1-backend.did.js")._SERVICE>}
 */
export const news_app_use_MPb1_backend = createActor(canisterId);
