...
import { idlFactory } from './glue-testapp-backend.did.js';
export { idlFactory } from './glue-testapp-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_GLUE_TESTAPP_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./glue-testapp-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the glue-testapp-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./glue-testapp-backend.did.js")._SERVICE>}
 */
export const glue_testapp_backend = createActor(canisterId);
