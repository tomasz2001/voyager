...
import { idlFactory } from './data_center_backend.did.js';
export { idlFactory } from './data_center_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DATA_CENTER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./data_center_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the data_center_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./data_center_backend.did.js")._SERVICE>}
 */
export const data_center_backend = createActor(canisterId);
